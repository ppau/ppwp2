...
<div class="mdl-grid mdlwp-1200 pir-cards hp-row-one">
    <div class="mdl-cell mdl-cell--4-col">
        <div class="pir-card pir-card__tall-ship mdl-card mdl-shadow--2dp">
            <div class="mdl-card__supporting-text">
                <h2 class="mdl-card__title-text">Party time!</h2>
            </div>
    ...
    <div class="mdl-cell mdl-cell--4-col">
        <div class="pir-card pir-card__data-retention mdl-card mdl-shadow--2dp">
            <div class="mdl-card__supporting-text">
                <h2 class="mdl-card__title-text">Data retention</h2>
            </div>
            <div class="mdl-card__title mdl-card--expand">
                <h2 class="mdl-card__title-text">Learn how to protect the privacy of yourself &amp; your family</h2>
            </div>
            <div class="mdl-card__actions mdl-card--border">
                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
                    Read more
