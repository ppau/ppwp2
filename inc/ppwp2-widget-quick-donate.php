...
class ppwp2_widget_quick_donate extends WP_Widget
{
	...
	{
		return $pin_uri . "?amount=%24" . $amount . "&amp;description=One-off+donation&amp;amount_editable=true&amp;success_url=https%3A%2F%2Fpirateparty.org.au%2Fdonate-thank-you%2F";
	}
	...
	public function form($instance)
	{
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id('pin_uri'); ?>"
                   name="<?php echo $this->get_field_name('pin_uri'); ?>" type="text"
                   value="<?php echo esc_attr($pin_uri); ?>"/>
        </p>
